# Дашборд контроля заявок и звонков для Bitrix24

Публичная безопасная версия операционного дашборда для контроля входящих заявок, исходящего прозвона и активности сотрудников по звонкам.
...
В рабочей версии дашборд может получать данные из:
